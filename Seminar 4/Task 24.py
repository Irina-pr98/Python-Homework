...
garden_list = [random.randint(1, 11) for _ in range(amount_bush)]
print(f'Количество ягод на каждом из кустов: {garden_list}')
max_sum = 0
for number_bush in range(amount_bush):
    ...
    if max_berries > max_sum:
        max_sum = max_berries
print(f'Максимальное количество ягод с трех кустов: {max_sum}')
